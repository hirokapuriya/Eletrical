...
<form name="loginform" action="login_exec.php" method="post">
    <div class="svgContainer" >
        <div>
            <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                ...
                <circle cx="100" cy="100" r="100" fill="354b63"/>
                <g class="body">
                ...
                <g class="arms" clip-path="url(#armMask)">
                    <g class="armL">
                        ...
                        <path fill="354b63" d="M178.8 74.7l2.2-.6c1.1-.3 2.2.3 2.4 1.4.3 1.1-.3 2.2-1.4 2.4l-2.2.6-1-3.8zM180.1 64l2.2-.6c1.1-.3 2.2.3 2.4 1.4.3 1.1-.3 2.2-1.4 2.4l-2.2.6-1-3.8zM175.5 54.9l2.2-.6c1.1-.3 2.2.3 2.4 1.4.3 1.1-.3 2.2-1.4 2.4l-2.2.6-1-3.8zM152.1 49.4l2.2-.6c1.1-.3 2.2.3 2.4 1.4.3 1.1-.3 2.2-1.4 2.4l-2.2.6-1-3.8z"/>
    ...
    <div class="inputGroup inputGroup3">
        ...
        <button type="submit" value="login" id="login" class="btn btn-primary">Login Now</button>
    </div>  
</form>
<script>
...
function coverEyes() {
    TweenMax.to(armL, .45, {x: -88, y: 2, rotation: 0, ease: Quad.easeOut});
    TweenMax.to(armR, .45, {x: -95, y: 2, rotation: 0, ease: Quad.easeOut, delay: .1});
}
