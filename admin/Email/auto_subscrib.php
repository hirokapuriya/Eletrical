        ...
        { */  //var_dump($value['email_msg']); die('opo');
            ...
            * {
            ...
            @media only screen and (max-width: 640px) {
              ...
              $headers = 'From: kapuriyahiren8899@gmail.com' . "\r\n" .
                      'Reply-To: kapuriyahiren8899@gmail.com' . "\r\n" .
              ...
              $message.='</head>
                                        ...
                                        <td class="container" width="600">
                                            <div class="content">
                                                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="alert alert-warning">'.$subscribe_email.'</td>
                                                    </tr>
                                                    <tr>
                ...
                if(mail($subscribe_email, $subject, $message, $headers))
                {
