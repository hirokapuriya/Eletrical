    ...
    <div id="carousel-example-generic" class="carousel slide carousel-fade"> 
      ...
      <div class="carousel-inner" role="listbox"> 
        ...
        <div class="item slide1 active">
          <div class="row">
            <div class="container">
              <div class="col-md-4 col-sm-5 text-center hidden-sm hidden-md hidden-lg"> <img data-animation="animated zoomInLeft" src="images/slider-img1.png" alt="" class="animated zoomInLeft"> </div>
              <div class="col-md-8 col-sm-7 text-left">
                ...
                <p data-animation="animated bounceInRight" class="">Lorem Ipsum is simply dummy text of the industry<span> industry's standard dummy text.</span></p>
                <a class="btn btn-hero" data-animation="animated bounceInLeft" href="http://sbtechnosoft.com/electricshop/contact.html">Contact Us</a> </div>
              <div class="col-md-4 col-sm-5 text-right hidden-xs"> <img data-animation="animated zoomInLeft" src="images/slider-img1.png" alt="" class=""> </div>
            </div>
          </div>
        </div>
        <!-- Item 2 -->
      ...
      <!-- End Wrapper for slides--> <a class="left carousel-control" href="http://sbtechnosoft.com/electricshop/#carousel-example-generic" role="button" data-slide="prev"> <i class="fa fa-angle-left"></i><span class="sr-only">Previous</span> </a> <a class="right carousel-control" href="http://sbtechnosoft.com/electricshop/#carousel-example-generic" role="button" data-slide="next"> <i class="fa fa-angle-right"></i><span class="sr-only">Next</span> </a> </div>
  </div>
</div>
<!-- Banner Wrapper End --> 
<!-- cta Wrapper Start -->
<div class="cta-wrapper">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-3">
        <div class="cta-inner cta-btn"> <a href="contact.php">Call Us Now <i class="fa fa-arrow-right" aria-hidden="true"></i></a> </div>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="single-services">
            <div class="services-inner">
              ...
              <div class="our-services-text">
                ...
                <a href="service.php">Read More</a> </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="display-table"> 
        ...
        <div class="display-table-cell width-50">
          <div class="service-image">
            ...
            <img src="images/about-us-img.jpg" alt="" title=""></div>
        </div>
        <!-- display-table-cell -->
        <div class="display-table-cell width-50">
...
<div class="join-wrapper">
  <div class="container">
    ...
    <a href="contact.php">Join Us Now</a> </div>
</div>
    ...
    <div class="row">
      <div class="col-md-8 col-sm-12 col-md-offset-2 col-sm-offset-0 col-xs-offset-0">
        ...
        <div class="owl-stage-outer">
          <div class="owl-stage" style="transform: translate3d(-1520px, 0px, 0px); transition: 0s; width: 5320px;">
              <div class="owl-item cloned" style="width: 750px; margin-right: 10px;">
                <div class="item">
                  <p>dskjfdfoignio,bgidf</p>
                </div>
              </div>
              <div class="owl-item cloned" style="width: 750px; margin-right: 10px;">
                <div class="item">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="counter">
          ...
          <div class="counter-right">
            <div class="number animateNumber" data-num="60"> <span>80</span></div>
